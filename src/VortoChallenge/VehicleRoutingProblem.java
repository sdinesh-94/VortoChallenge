...
public class VehicleRoutingProblem {
	...
	public static void main(String args[]) throws IOException {
		...
		/*
		 * Intutively we see that the solutions space contains a global minima. This
		 * could be represented as an inverted bell curve with the global minima being
		 * the lowest cost configuration. Therefore we start with 1 cluster (driver) to
		 * cover N points and we increase it till k clusters setup such that optimal
		 * configuration of the kth cluster is lower than optimal configuration of k-1
		 * clusters setup and k+1 cluster setup
		 */
